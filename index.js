...
}//console.log('Task 6:', addArtist(artists, 'Caleb', 25, 'Web Design', 'American', 'I have a background in customer service at Big Retail Chain. I am attending BloomTech to become a Frontend Developer.' ));
//completed
...
if(array[i].name === name) {
 ...
 console.log('Task 8:', artistInfo(artists, 'Kazimir Severinovich Malevich'));
